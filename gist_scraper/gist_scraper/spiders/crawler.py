...
class CodeSnippetCrawler:
    ...
    def crawl(self, url, site, max_depth=2, delay=0.3):
...
# Example usage
sites = {
    "stackoverflow": "https://www.pythonguis.com/code/",
    "github_gist": "https://therenegadecoder.com/code/python-code-snippets-for-everyday-problems/#code-snippet-repository",
