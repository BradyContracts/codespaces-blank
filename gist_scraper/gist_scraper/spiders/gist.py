...
class CodeSnippetCrawler:
    ...
    def crawl(self, url, site, max_depth=5, delay=2):
...
# Example usage
sites = {
    "pythoncheatsheet": "https://www.pythoncheatsheet.org/cheatsheet/dictionaries",
}
...
for site, url in sites.items():
    collected_snippets[site] = crawler.crawl(url, site, max_depth=5)
